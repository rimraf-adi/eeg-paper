...
\midrule
\textbf{0} & \textbf{0.762} & \textbf{0.688} & \textbf{0.683} & \textbf{0.694} & \textbf{0.807} & \textbf{0.738} & \textbf{0.731} & \textbf{0.683} & \textbf{0.786} & \textbf{0.858} \\
...
\midrule
$\mu{\pm}\sigma$ & $0.694{\pm}0.049$ & $0.538{\pm}0.159$ & $0.726{\pm}0.134$ & $0.488{\pm}0.253$ & $0.732{\pm}0.058$ & $0.636{\pm}0.136$ & $0.494{\pm}0.154$ & $0.802{\pm}0.108$ & $0.398{\pm}0.228$ & $0.730{\pm}0.160$ \\
\botrule
\end{tabular*}
}
\end{table}
...
Trial & Acc & F1 & Prec & Rec & AUC & Acc & F1 & Prec & Rec & AUC \\
\midrule
\textbf{0} & \textbf{0.672} & \textbf{0.647} & \textbf{0.546} & \textbf{0.792} & \textbf{0.790} & \textbf{0.678} & \textbf{0.703} & \textbf{0.603} & \textbf{0.843} & \textbf{0.779} \\
...
\midrule
$\mu{\pm}\sigma$ & $0.651{\pm}0.015$ & $0.653{\pm}0.057$ & $0.621{\pm}0.048$ & $0.705{\pm}0.134$ & $0.707{\pm}0.051$ & $0.572{\pm}0.109$ & $0.557{\pm}0.124$ & $0.550{\pm}0.120$ & $0.636{\pm}0.224$ & $0.658{\pm}0.098$ \\
\botrule
\end{tabular*}
}
\end{table}
...
Trial & Acc & F1 & Prec & Rec & AUC & Acc & F1 & Prec & Rec & AUC \\
\midrule
\textbf{5} & \textbf{0.681} & \textbf{0.566} & \textbf{0.635} & \textbf{0.511} & \textbf{0.703} & 0.434 & 0.339 & 0.756 & 0.219 & 0.598 \\
...
\textbf{3} & 0.609 & 0.566 & 0.617 & 0.524 & 0.654 & \textbf{0.681} & \textbf{0.564} & \textbf{0.517} & \textbf{0.620} & \textbf{0.727} \\
1 & 0.582 & 0.564 & 0.472 & 0.702 & 0.645 & 0.621 & 0.607 & 0.593 & 0.620 & 0.671 \\
\midrule
$\mu{\pm}\sigma$ & $0.629{\pm}0.038$ & $0.587{\pm}0.100$ & $0.607{\pm}0.086$ & $0.591{\pm}0.163$ & $0.652{\pm}0.043$ & $0.561{\pm}0.125$ & $0.538{\pm}0.114$ & $0.578{\pm}0.132$ & $0.610{\pm}0.271$ & $0.674{\pm}0.048$ \\
\botrule
\end{tabular*}
}
\end{table}
